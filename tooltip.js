...
function modalStuff() {
    ...
    function donateClick(e) {
        ...
        // gtag('event', 'Donate Â£'+amount+' Click', {
        //   'event_category': 'Popup',
        //   'event_label': 'Variant ' + variant
        // });
        ga('send', 'event', 'Popup', 'Donate Â£' + amount + ' Click', 'Variant ' + variant);
        if (e.which === 2) {
