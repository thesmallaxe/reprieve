  ...
  $.smallipop = sip = {
    ...
    */
    ...
    _getInstance: function(id, isTour) {
      ...
      instance = $(sip.templates.popup).css({'opacity': 0, 'minWidth':  $(sip.templates.popup).attr('data-min-width'), 'maxWidth':  $(sip.templates.popup).attr('data-max-width')}).attr('id', "smallipop" + (sip.nextInstanceId++)).addClass('smallipop-instance').data({
        xDistance: 0,
        yDistance: 0,
        isTour: isTour
      }).bind({
